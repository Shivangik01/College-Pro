...
import com.example.spit_app.user.events.EventDisplay;
import com.example.spit_app.user.announcements.Announcement;

import java.util.List;

public class Recycler_Adapter_events extends RecyclerView.Adapter<Recycler_Adapter_events.ViewHolder> {
    private List<Announcement> list;
    private Context context;
    public Recycler_Adapter_events(List<Announcement> list, Context context){
        this.list=list;
